...
class IntercambioObjetoAceptadoEmail
{
    ...
    {
        $email = Email::create($intercambio->usuarioIntercambio()->email(), 'Petición Intercambio Aceptada', 'Email/IntercambioObjetoAceptado.html.twig',
            [
        ...
        $email = Email::create($intercambio->usuarioIntercambiar()->email(), 'Petición Intercambio Aceptada', 'Email/IntercambioObjetoAceptado.html.twig',
            [
